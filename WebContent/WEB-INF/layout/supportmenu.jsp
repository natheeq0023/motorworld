 ...
 <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:400px;background-color:#C1C1C1;padding-top:30px;margin-top:80px;">
                    <li class="active">
                        <a href="supporthome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                   
                    <li>
                        <a href="createitem.htm"><i class="fa fa-fw fa-table"></i>Create Item</a>
                    </li>
                    
                       <li>
                        <a href="edititem.htm"><i class="fa fa-fw fa-table"></i>Edit Item</a>
                    </li>
                    
                      <!--  <li>
                        <a href="viewitem.htm"><i class="fa fa-fw fa-table"></i>View</a>
                    </li> -->
                     <li class="dropdown">
                         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-desktop"></i>View</a>
                       <ul class="dropdown-menu">
                       	    <li>
                        	  <a href="viewaccount.htm">ViewAccounts</a>
                    		</li>
                    		
                    		<li>
                        	  <a href="viepage.htm">ViewPage</a>
                    		</li>
                    		<li>
                        	  <a href="vieitem.htm">ViewItem</a>
                    		</li>
