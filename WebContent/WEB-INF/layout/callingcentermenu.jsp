 ...
 <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
           ...
           <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:380px;background-color:#C1C1C1;padding-top:30px;margin-top:80px;">
                    <li class="active">
                        <a href="callingcenterhome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                   
                       <li>
                        <a href="viewaccount.htm"><i class="fa fa-fw fa-table"></i>ViewAccounts</a>
                    </li>
                      <li>
                        <a href="viewmachine.htm"><i class="fa fa-fw fa-table"></i>ViewMachine</a>
                    </li>
                      <li>
                        <a href="viewlock.htm"><i class="fa fa-fw fa-table"></i>ViewLock</a>
                    </li>
                     <li>
                        <a href="viewwarehouse.htm"><i class="fa fa-fw fa-table"></i>ViewWarehouse</a>
                    </li>
