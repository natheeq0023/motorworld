        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:450px;background-color:#C1C1C1;padding-top:40px;margin-top:80px;">
                    <li class="active">
                        <a href="supplierhome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                    
                     <li class="active">
                        <a href="machines.htm"><i class="fa fa-fw fa-dashboard"></i>Machines</a>
                    </li>
                    <li class="active">
                        <a href="items.htm"><i class="fa fa-fw fa-dashboard"></i>Items</a>
                    </li>
                      ...
                      <li class="dropdown">
                         ...
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="itemlock.htm"><i class="fa fa-fw fa-bar-chart-o"></i>item & lock</a>
                        </li>
