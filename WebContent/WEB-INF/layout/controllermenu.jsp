        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:600px;background-color:#C1C1C1;padding-top:30px;margin-top:80px;">
                   ...
                   <li class="dropdown">
                         <a href="controlaccount.htm"> <i class="fa fa-fw fa-table"></i> Account</a>
                                             </li>
                    <li>
                        <a href="machinecontrolpage.htm"><i class="fa fa-fw fa-table"></i>Machine</a>
                    </li>
                    <li>
                        <a href="lockcontrolpage.htm"><i class="fa fa-fw fa-edit"></i>Lock</a>
                    </li>
