        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:450px;background-color:#C1C1C1;padding-top:40px;margin-top:80px;">
                    ...
                    <li>
                        <a href="machinetransfer.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Machine</a>
                    </li>
                    <li>
                        <a href="locktransfer.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Lock</a>
                    </li>
                    <li>
                        <a href="accountspercentage.htm"><i class="fa fa-fw fa-table"></i>PasswordGenerator</a>
                    </li>
                     <li>
                        <a href="saleonline.htm?q=Accept"><i class="fa fa-fw fa-table"></i>SaleOnline</a>
                    </li>
