        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:450px;background-color:#C1C1C1;padding-top:40px;margin-top:80px;">
                    <li class="active">
                        <a href="salesmanhome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                     <li class="active">
                        <a href="invoice.htm"><i class="fa fa-fw fa-dashboard"></i> Create Invoice</a>
                    </li>
                    <li class="active">
                        <a href="warehousemachines.htm"><i class="fa fa-fw fa-dashboard"></i> Machines</a>
                    </li>
                     <li class="active">
                        <a href="warehouselocks.htm"><i class="fa fa-fw fa-dashboard"></i>Locks</a>
                    </li>
                     <li class="active">
                        <a href="saleonline.htm?q=Accept"><i class="fa fa-fw fa-dashboard"></i> saleonline</a>
                    </li>
                 
                     
                      <li class="dropdown">
                         <a href="salesman.htm" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> operators</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="createoperator.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Create Operator</a>
                        </li>
                        <li>
                        	<a href="operators.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Operators</a>
                        </li>
