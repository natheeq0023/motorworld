        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:450px;background-color:#C1C1C1;padding-top:40px;margin-top:80px;">
                    <li class="active">
                        <a href="operatorhome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                   
                     <li>
                        <a href="createaccount.htm"><i class="fa fa-fw fa-bar-chart-o"></i>  Create Supplier</a>
                    </li>
                    <li>
                        <a href="buyfromagency.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Buy from Agency</a>
                    </li>
                     <li >
                        <a href="myorders.htm"><i class="fa fa-fw fa-dashboard"></i>My Orders</a>
                    </li>
                     <li class="dropdown">
                         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> Connect</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="machinelock.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Machine & Lock</a>
                        </li>
                        <li>
                        	<a href="machinesupplier.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Machine & Supplier</a>
                        </li>
                         <li>
                        	<a href="machinepartner.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Machine & Partner</a>
                        </li>
                         <li>
                        	<a href="itemsupplier.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Items & Supplier</a>
                        </li>
                     ...
                     <li class="dropdown">
                         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> Create Partner</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="addpartner.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Add Partner</a>
                        </li>
                        <li>
                        	<a href="allpartners.htm"><i class="fa fa-fw fa-bar-chart-o"></i>All Partners</a>
                        </li>
                    ...
                    <li class="dropdown">
                         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> Items</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="createitem.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Create Item</a>
                        </li>
                        <li>
                        	<a href="createitemprice.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Create Item Price</a>
                        	
                        </li>
                         <li>
                        	<a href="createitemquatinty.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Create Item Quantity</a>
                        	
                        </li>
                        <li>
                       
                        	<a href="items.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Items</a>
                        </li>
                    ...
                    <li>
                        <a href="sofaware.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Software</a>
                   </li>
                    <li class="dropdown">
                         <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> Warehouse</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="createwarehouse.htm"><i class="fa fa-fw fa-bar-chart-o"></i> Create Warehouse</a>
                        </li>
                        <li>
                        	<a href="warehouses.htm"><i class="fa fa-fw fa-bar-chart-o"></i> warehouses</a>
                        </li>
