        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:450px;background-color:#C1C1C1;padding-top:40px;margin-top:80px;">
                    <li class="active">
                        <a href="partnerhome.htm"><i class="fa fa-fw fa-dashboard"></i> Home</a>
                    </li>
                     
                 
                     
                      <li class="dropdown">
                         <a href="salesman.htm" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-bar-chart-o"></i> Locations</a>
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="createlocation.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Create Location</a>
                        </li>
                        <li>
                        	<a href="locations.htm"><i class="fa fa-fw fa-bar-chart-o"></i>Locations</a>
                        </li>
                     ...
                     <li>
                        <a href="allpartnerContract.htm?cid=${sessionScope.userRole.customerId}"><i class="fa fa-fw fa-bar-chart-o"></i>All Partner Contract</a>
                    </li>
                     <li >
                        <a href="myorders.htm"><i class="fa fa-fw fa-dashboard"></i>Kind of Contract</a>
                    </li>
                    <li>
                        <a href="machineView.htm?cid=${sessionScope.userRole.userRoleId}"><i class="fa fa-fw fa-bar-chart-o"></i>Machine</a>
