...
<c:if test="${not empty param.s}">
	<div class="alert alert-success fade in" id="divSuccess">
		...
		<strong>Success!</strong> Your Salesman has been connect to Branch
		successfully.
	</div>
</c:if>
...
<div class="row">
	...
	<div class="col-xs-5 col-md-6">
		...
		<div class="form-group">
			<div class="">
				<input type="text" class="form-control" size="10" id="userId"
					name="userId" placeholder="Salesman ID" required>
			</div>
		</div>
	...
	<div class="col-xs-2 col-md-2">
		<button type="button"
			class="btn btn-lableinfo btn-pressure btn-sensitive" id="btnCheck">
			Check
		</button>
	</div>
</div>
...
<div id="divConnect" style="display: none">
	...
	<div class="row">
		...
		<div class="col-xs-5 col-md-2" align="right">
			<label for="concept" class="col-xs-5 col-md-3 control-label-left">
				Full&nbsp;Name
			</label>
		</div>
		<div class="col-xs-5 col-md-6">
			<div class="form-group">
				<input type="text" class="ctextbox" name="fullName" id="fullName"
	...
	<div class="row">
		...
		<div class="col-xs-5 col-md-2">
			<div class="form-group">
				<input type="text" class="ctextbox" name="country" id="country"
					size="15" readonly="readonly" />
			</div>
	...
	<form action="connectbranch.htm" method="post"
		onsubmit="return validate(this);">


		<c:if test="${requestScope.branches ne null}">
			<!-- row  -->
			<div class="row">
				<div class="col-md-9">
									...
									<tr>
										...
										<td>
											<input type="checkbox" name="branchId"
												id="branchId${branch.branchId}" value="${branch.branchId}">
										</td>
									</tr>
...
<script>
	...
	function validate(formObj)
	{
		...
		{
			alert("please select atleast one Brach");
			return false;
		}
		return true;
	}
