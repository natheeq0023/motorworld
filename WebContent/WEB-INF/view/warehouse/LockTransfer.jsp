...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Your LockTransfer has been transfered successfully.
</div>
</c:if>
...
<br/>
 <form action="machinetransfer.htm" method="post" onsubmit="return validate(this);">
<!-- row  -->
<div class="row">
        <div class="col-md-9">
