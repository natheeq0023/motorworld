...
<!-- row  -->
   ...
   <div class="col-xs-8 col-md-8" align="center">
        <div class="form-group">
           <button type="button" class="btn btn-lableinfo btn-pressure btn-sensitive">&nbsp;&nbsp;&nbsp; Items details&nbsp;&nbsp;&nbsp;</button> 
         </div>
            ...
            <table class="col-md-9 table-bordered table-striped table-condensed cf">
        		<thead class="cf">
        			<tr>
        				...
        				<th class="lbl-lableinfo" >Item Barcode</th>
        		...
        		<tbody>
        		<c:forEach items="${requestScope.items}" var="item" varStatus="st">
        			<tr>
        				<td>
        					${st.count }
        				</td>
