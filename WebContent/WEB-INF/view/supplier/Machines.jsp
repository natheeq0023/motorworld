...
<!-- row  -->
   ...
   <div class="col-xs-8 col-md-8" align="center">
        <div class="form-group">
           <button type="button" class="btn btn-lableinfo btn-pressure btn-sensitive">&nbsp;&nbsp;&nbsp; Machine details&nbsp;&nbsp;&nbsp;</button> 
         </div>
   ...
   <!-- end row -->
   <c:if test="${requestScope.machines ne null}">
   <!-- row  -->
   <div class="row">
        <div class="col-md-9">
            ...
            <table class="col-md-9 table-bordered table-striped table-condensed cf">
        		<thead class="cf">
        			<tr>
        				...
        				<th class="lbl-lableinfo" >Machine Kind </th>
        				<th class="lbl-lableinfo" >Machine Model  </th>
        				
        				<th class="lbl-lableinfo" >Machine Colour</th>
        		...
        		<c:forEach items="${requestScope.machines}" var="machine" varStatus="st">
        			<tr>
        				...
        				<td>
        					${machine.machineColour }
        				</td>
        				<td>
        					<a href="locks.htm?machineId=${machine.machineId}">Locks</a>
        				</td>
        			</tr>
