...
<button type="submit" class="btn btn-success btn-bold" id="btnMachines" > MachineDetails</button> 
		...
		$('#divNoMachines').css("display", "none"); 
			...
			$.ajax({
				...
				success : function(response) {
						var map = {};
						$.each(response, function(i, machine) {
							var machineId=machine.machineId;
							var machineKind=machine.machineKind;
							var machineModel=machine.machineModel;
							if(map[machineKind+"|"+machineModel])
							{
								var count=parseInt(map[machineKind+"|"+machineModel])+1;
								map[machineKind+"|"+machineModel]=count;
							
							}
							else
							{
								map[machineKind+"|"+machineModel]=1;
							}
