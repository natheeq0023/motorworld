...
<div>
   ...
   <div class="row">
     ...
     <label for="concept" class="btn btn-lableinfo btn-pressure btn-sensitive">Warehouse SNO </label>
   </div>
...
<div class="alert alert-danger fade in" id="divInvalid" style="display:none">
    <a href="#" class="close" data-dismiss="alert">&times;</a>
    <strong>Error!</strong> In valid WarehouseSNO.
</div>
...
<script>
	...
	$('#btnCheck').click(
		...
		$('#divInvalid').css("display", "none"); 
			...
			if(id=="")
			{
				alert("please enter warehouse SNO");
				$('#pageSNO').focus()
				return false;
			}
