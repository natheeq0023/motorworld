...
<!-- row  -->
   ...
   <div class="col-xs-8 col-md-8" align="center">
        <div class="form-group">
           <button type="button" class="btn btn-lableinfo btn-pressure btn-sensitive">&nbsp;&nbsp;&nbsp; Loaction details&nbsp;&nbsp;&nbsp;</button> 
         </div>
   ...
   <!-- end row -->
   <c:if test="${requestScope.locations ne null}">
   <!-- row  -->
   <div class="row">
        <div class="col-md-9">
            ...
            <table class="col-md-9 table-bordered table-striped table-condensed cf">
        		<thead class="cf">
        			<tr>
        				...
        				<th class="lbl-lableinfo" >Type</th>
        				<th class="lbl-lableinfo" >Name</th>
        		...
        		<tbody>
        		<c:forEach items="${requestScope.locations}" var="location" varStatus="st">
        			<tr>
        				<td>
        					${st.count }
        				</td>
        				...
        				<td>
        					<a href="machines.htm?locationId=${location.locationId}">Machines</a>
        				</td>
        			</tr>
