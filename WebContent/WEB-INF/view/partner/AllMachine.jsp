            ...
            <table class="col-md-9 table-bordered table-striped table-condensed cf">
        		<thead class="cf">
        			<tr>
        				...
        				<th class="lbl-lableinfo" >Machine Status</th>
        				<th class="lbl-lableinfo" >View</th>
        				
        			</tr>
        		</thead>
        		<tbody>
        		<c:forEach items="${requestScope.machine}" var="machine" varStatus="st">
        			<tr>
        				<td>
        					${st.count }
        				</td>
        				...
        				<td>
        					<a href="viewMachine.htm?i=${machine.machineSno}">View</a>
        				</td>
        			</tr>
