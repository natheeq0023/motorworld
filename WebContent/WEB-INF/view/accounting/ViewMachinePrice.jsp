...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Your Machine Price has been Updated Successfully!.
</div>
</c:if>
...
<button type="button" class="btn btn-success btn-bold" id="btnCheck">Check</button> 
 ...
 <div id="divMachinePrice" style="display:none">
 	...
 	<form action="editmachinepage.htm" method="post" >
 		<!-- row  -->
      <!-- end row -->
   <!-- row  -->
   ...
   <div class="col-xs-5 col-md-6">
        ...
        <input type="hidden" name="machineId" id="machineId"/>
         <input type="hidden" name="machinePriceId" id="machinePriceId"/>
    <input type="submit" class="btn btn-control" id="btnPause" name="accountStatus" value="Edit Machine" onclick="return(profile());"/>
    <input type="submit" class="btn btn-control" id="btnBlock" name="accountStatus" value="Delete Machine" />
   </div>
   </div>
   </div>
   <!-- end row -->
