...
<div class="row">
        <div class="col-md-9">
   <div id="divMachineSalesHostory" style="display:none">
...
$('#country').change(
	...
	$('#btnShow').click(
		...
		$('#divMachineSalesHostory').css("display", "none"); 
			var country = $('#country').val();
			var city = $('#city').val();
			...
			var data = 'country='
					+ encodeURIComponent(country)+'&userRoleId='+encodeURIComponent(userRoleId)+'&city='+ encodeURIComponent(city)+'&model='+encodeURIComponent(machineModel)+'&orderFor=machine';
			...
			$.ajax({
				...
				success : function(response) {
						...
						$('#divMachineSalesHostory').css("display", "block"); 
						$("#tb").empty();
