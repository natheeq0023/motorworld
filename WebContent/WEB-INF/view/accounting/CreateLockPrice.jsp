...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Your Lock Price has been created successfully.
</div>
</c:if>
 ...
 <div id="divLockPrice" >
 	...
 	<form action="createlockprice.htm" method="post" onsubmit="return validate(this);">
 		<!-- row  -->
   <div class="row">
   ...
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
           <input type="text" name="price" id="price" class="form-control" onkeypress="javascript:return isNumber (event)" onkeyup="calcFinalPrice()"/>
         </div>
...
<button type="submit" class="btn btn-success btn-bold" id="btnCheck" >Save Lock Price</button> 
