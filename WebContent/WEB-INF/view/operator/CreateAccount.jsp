...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Your Supplier Account has been created successfully.
</div>
</c:if>
<style>
.ctextbox
...
<form action="createaccount.htm" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
   ...
   <div class="col-xs-5 col-md-2">
        <div class="form-group">
           ...
           <input type="submit" class="btn btn-lableinfo btn-pressure btn-sensitive" id="btnSubmit" value="Create Supplier" />
         </div>
