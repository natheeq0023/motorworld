...
<c:if test="${not empty param.s}">
	<div class="alert alert-success fade in" id="divSuccess">
		...
		<strong>Success!</strong> Your Item Price has been created
		successfully.
	</div>
</c:if>
...
<div id="divItemPrice">
  ...
  <div id="itemDetails" style="display:none">
   ...
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
           <input type="text" name="itemName" id="itemName" class="form-control" readonly="readonly"/>
   ...
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
           <input type="text" name="itemGruop" id="itemGruop" class="form-control" readonly="readonly"/>
   ...
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
           <input type="text" name="itemSize" id="itemSize" class="form-control" readonly="readonly"/>
         </div>
			...
			$.ajax({
				...
				success : function(response) {
					...
					else
					{
						...
						$("#itemPhotoName").attr("src","/uploads/item/"+response.itemId+"/"+response.itemPhotoName);
