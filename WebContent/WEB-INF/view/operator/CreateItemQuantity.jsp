...
<button type="button" class="btn btn-success btn-bold" id="addItem" >Place Item Quantity</button> 
...
<div id="divAddQuatity" style="display:none">
		<!-- row -->
   <div class="row" >
...
<button type="submit" class="btn btn-success btn-bold" id="btnQuantity" > Add Item Quantity</button> 
  ...
  $('#itemBarcode').blur(function() {
   	...
   	$('#itemDetails').css("display", "none"); 	
			...
			$.ajax({
				...
				$('#addItem').click(
					function(event) {
					$('#divAddQuatity').css("display", "block"); 
					...
					$('#warehouseId').find('option:selected').text();
					...
					for(var index=0;index<tbodyRows;index++)
					{
						...
						if(itemBarcode==titemBarcode && twarehouseName==warehouseName)
						{
					...
					var appendTxt = "<td>"+itemBarcode+"</td><td>"+itemName+"</td><td>"+itemQuantity+"</td><td>"+warehouseName+"</td><td><a  onclick='deleteRow(this)'>delete</a><input type='hidden' name='itemId' value='"+itemId+"'  id='itemId'/><input type='hidden' name='iquantity' id='iquantity' value='"+itemQuantity+"'/><input type='hidden' name='warehouseId' id='warehouseId' value='"+warehouseId+"'/></td>";
				...
				function deleteRow(obj)
			{
				...
				else
				{
					...
					$('#divAddQuatity').css("display", "none"); 
				}
