...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Machine has been ${param.s } successfully.
</div>
</c:if>
<style>
	.form-control {
...
<div>
   ...
   <div class="row">
     ...
     <label for="concept" class="btn btn-lableinfo btn-pressure btn-sensitive">Machine SNO </label>
   </div>
...
<div class="alert alert-danger fade in" id="divInvalid" style="display:none">
    <a href="#" class="close" data-dismiss="alert">&times;</a>
    <strong>Error!</strong> In valid Machine Sno.
</div>
...
<form action="updatepagestatus.htm" method="post">
   ...
   <div class="col-xs-5 col-md-2" align="right">
     <label for="concept" class="col-xs-5 col-md-3 control-label-left">Machine Status</label>
   </div>
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
...
<script>
	...
	$('#btnCheck').click(
		...
		$('#btnView').click(
		function(event) {
			window.location="viewmachinepage.htm?&id="+$("#id").val();
		});
