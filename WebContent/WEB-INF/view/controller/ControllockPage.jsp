...
<c:if test="${not empty param.s}">
    ...
    <strong>Success!</strong> Lock has been ${param.s }ed successfully.
</div>
</c:if>
<style>
	.form-control {
...
<div class="alert alert-danger fade in" id="divInvalid" style="display:none">
    <a href="#" class="close" data-dismiss="alert">&times;</a>
    <strong>Error!</strong> In valid Lock Sno.
</div>

         

<div id="divControl" style="display:none">
<form action="updatelockstatus.htm" method="post">
   ...
   <div class="col-xs-5 col-md-2" align="right">
     <label for="concept" class="col-xs-5 col-md-3 control-label-left">Lock Status</label>
   </div>
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
...
<script>
	...
	$('#btnCheck').click(
		...
		$('#btnView').click(
		function(event) {
			window.location="viewlock.htm?&id="+$("#id").val();
		});
